...
(function () {
    ...
    root.innerHTML = `
      <div class="login">
        <div class="login-box">
          ...
          <p class="login-sub">${U.esc(cfg.sector || "Setor de Furação")}</p>
      ...
      <div class="card pad" style="background:var(--panel)">
        <div class="rowc">
          <div class="f1">
            ...
            <div class="tiny dim">${U.esc(po.machineName)} · ${po.operacao === "retrabalho" ? "Retrabalho" : "Produção"}</div>
          </div>
  ...
  function newPOForm(o) {
    const np = state.newPO[o.id] || { machineId: "", product: "", quantityPlanned: "", operacao: "producao" };
    return `
      <div class="card pad">
        <div class="rowc between mb12">
  ...
  function bindAllExtra() {
    ...
    document.querySelectorAll("[data-npo-k]").forEach(el => {
      ...
      if (!state.newPO[oid]) state.newPO[oid] = { machineId: "", product: "", quantityPlanned: "", operacao: "producao" };
  ...
  function onClickGlobal(e) {
    ...
    else if (a === "new-po") { state.newPOForm[id] = true; state.newPO[id] = { machineId: "", product: "", quantityPlanned: "", operacao: "producao" }; renderView(); }
